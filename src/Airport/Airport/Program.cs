...
namespace Airport
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            foreach (var f in flightControl.Flights)
            {
                Console.WriteLine(f.DepartureAirport + f.ArrivalAirport + f.Hour + f.Minute);
            }

            Console.WriteLine("Данные сохранены в текстовый файл");
            Console.ReadKey();
        }
